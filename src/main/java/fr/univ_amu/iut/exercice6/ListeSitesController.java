...
public class ListeSitesController {
  ...
  public int ajouterSiteDemo() {
    ...
    siteCarte.numeroCarreProperty().set("Carré " + (640000 + compteurDemo));
    siteCarte.nombrePointsProperty().set((compteurDemo % 3) + 1);
    siteCarte.nombrePassagesProperty().set(compteurDemo * 2);
    siteCarte.joursDepuisDernierPassageProperty().set(compteurDemo * 4);

    conteneurCartes.getChildren().add(siteCarte);
